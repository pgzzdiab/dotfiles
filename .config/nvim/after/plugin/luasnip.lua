...
ls.snippets = {
  ...
  --       import numpy as np
  --       from simulation_framework.com.virtual_patient_simulator import (
  --           vp_constants,
  --           virtual_patient_simulator_utl as vp_utl,
  --           vp_ol_utl,
  --       )
  --       from simulation_framework.com import sim_source_data
  --       from common.time_utl import date_utl
  --     ]], {})
  --   )
...
-- ls.snippets = {
--   lua = {
-- 	s("att", fmt("local {} = {}", {i(1, "attribute"), rep(1)}))
--   }
-- }
